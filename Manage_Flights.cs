...
namespace Trip_Maker_Travel_Management_System_
{
    public partial class Manage_Flights : Form
    {
        ...
        {
            String query = "select * from Flights where FlightName Like '" + Search.Text + "%' ";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                String querry = "DELETE FROM FLIGHTS WHERE FlightName='" + flightName.Text + "'";
                c2.setData(querry);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                String querry = "INSERT INTO Flights (FlightName, Departure, Destination, Phone, TicketPrice) VALUES ('" + flightName.Text + "', '" + from.Text + "','" + to.Text + "','" + phone.Text + "'," + decimal.Parse(ticketPrice.Text) + ")";
                c2.setData(querry);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                String querry = "UPDATE Flights SET TicketPrice= " + decimal.Parse(ticketPrice.Text) + ", Phone='" + phone.Text + "',Departure='" + from.Text + "',Destination='" + to.Text + "' WHERE FlightName='" + flightName.Text + "'";
                c2.setData(querry);
